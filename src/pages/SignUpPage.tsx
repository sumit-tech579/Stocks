...
import { Mail, Lock, User, Eye, EyeOff, Sparkles, AlertCircle, ArrowRight, ShieldCheck } from 'lucide-react';
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Successfully registered! Navigate to email verification screen
      ...
      <div className="max-w-md w-full space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400">
            Join TradeNest & instantly receive <span className="font-semibold text-emerald-600 dark:text-emerald-400">₹1,00,000</span> virtual capital
          </p>
        </div>
        ...
        <Card className="p-6 sm:p-8 space-y-5 shadow-xl border-slate-200/80 dark:border-slate-800">
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            ...
            <Button
              ...
              disabled={isLoading || isGoogleLoading}
            >
              <span>Create Account & Claim ₹1,00,000</span>
          ...
          <div className="pt-2 border-t border-slate-100 dark:border-slate-800 space-y-3">
            ...
            >
              ...
              <span>Explore in Demo Mode (No Sign Up Needed)</span>
            </Button>

            <div className="flex items-center justify-center gap-1.5 text-xs text-slate-400 text-center">
              <ShieldCheck className="w-3.5 h-3.5 text-emerald-500 shrink-0" />
              <span>No real financial risk, no PAN/Aadhaar required.</span>
            </div>
          </div>
        </Card>
